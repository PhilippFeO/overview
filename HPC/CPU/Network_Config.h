...
// === Allgemeine Größen ===
// const int BATCH_SIZE = 100;			// Anzahl der Bilder, die einem Durchgang bearbeitet werden sollen (Zeilen der Matrix)
...
// const int NMB_FILTERS = 5;	// Anzahl der zu verwendeten Filter in der Conv-Schicht
